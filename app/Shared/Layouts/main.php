...
<head>
    ...
    <meta name="description" content="SALUVERA - Sistema de gestion para profesionales de la salud">
...
<body>
    ...
    <div class="app-wrapper">
        <header class="app-header">
            <div class="app-header-content">
                ...
                <div class="app-header-actions">
                    <span class="app-header-badge">v<?= APP_VERSION ?? '1.0.0' ?></span>
        ...
        <footer class="app-footer">
            <p>SALUVERA &copy; <?= date('Y') ?> - Sistema de gestion para profesionales de la salud</p>
        </footer>
    </div>
