<?php
/**
 * SALUVERA - Balance de ganancias del profesional
 *
 * @version 2.29.0
 */
...
<div class="dash-stats">
    <div class="dash-stat-card ganancia-card">
        ...
        <div class="dash-stat-value"><?= $fmt($mesActual['total_monto']) ?></div>
        <div class="dash-stat-label">Mes actual (<?= $mesActual['total_citas'] ?> consultas)</div>
    </div>
    ...
    <div class="dash-stat-card ganancia-card ganancia-destacada">
        ...
        <div class="dash-stat-value"><?= $fmt($rango['total_monto']) ?></div>
        <div class="dash-stat-label">Rango filtrado (<?= $rango['total_citas'] ?> consultas)</div>
    </div>
    ...
    <div class="dash-stat-card ganancia-card">
        ...
        <div class="dash-stat-value"><?= $fmt($historico['total_monto']) ?></div>
        <div class="dash-stat-label">Historico total (<?= $historico['total_citas'] ?> consultas)</div>
    </div>
    ...
    <div class="dash-stat-card ganancia-card">
        ...
        <div class="dash-stat-value"><?= $fmt($promedio) ?></div>
                ...
                <tbody>
                    <?php foreach ($citas as $c): ?>
                        <tr>
                            ...
                            <td style="text-align:right"><strong class="monto-celda"><?= $fmt($c['monto_consulta']) ?></strong></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align:right"><strong class="monto-celda"><?= $fmt($rango['total_monto']) ?></strong></td>
                    </tr>
                </tfoot>
            </table>
        </div>
